...
--memorize all defintions in this file
...
--forall a of type α, if a satifisies predicate s1 then a satisfies predicate s2
/-
...
--λ anonymous function, way of writing function without name, ?like treating functions as arbitrary type?
/-
...
def diff (s t: set α) : set α := {a | a ∈ s ∧ a ∉ t}
...
/-
can turn function from val to val to function from set to set
image is like applying function to set
